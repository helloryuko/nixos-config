...
pkgs.stdenv.mkDerivation rec {
  ...
  installPhase = ''
    ...
    pushd $IDADIR
      # Sophie: THIS SCRIPT IS NOT INCLUDED IN THE GITHUB REPOSITORY.
      # Use https://github.com/msanft/ida-pro-overlay instead of this flake if you need IDA Pro.
      ${
        if builtins.pathExists ./these_bitches_change_up_like_the_season.py then
          "${pkgs.python3}/bin/python3 ${./these_bitches_change_up_like_the_season.py} --oneshot"
        else ""
      }
    popd
